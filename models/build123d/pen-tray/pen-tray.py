"""Parametric pen tray — low-profile, 2 equal compartments.
...
Internal layout: NUM_COMPARTMENTS equal-width sections separated by thin
vertical dividers. Change NUM_COMPARTMENTS (e.g. to 3) and the dividers are
recomputed automatically to keep compartments equal.
...
# --- Compartments ---
NUM_COMPARTMENTS = 2  # number of equal-width sections (1 divider for 2, etc.)

OUTPUT_PATH = Path(__file__).parent / "output" / "pen-tray.stl"
